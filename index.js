...
const sandwich = createMenuItem("Sandwich", 6, "Lunch");
...
burger.discount = function discount(string) {
...
reviews.push({ name: 'Tucker', rating: 3, feedback: 'Food was decent but the service was slow' });
console.log(reviews);
